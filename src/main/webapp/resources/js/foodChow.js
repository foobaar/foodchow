...
function sendZipcode(zip){
    ...
    status = 0;
    xmlhttp.open("GET","http://enigmatic-savannah-6672.herokuapp.com/initialize?zip=" + zip,true);
    xmlhttp.send();
...
function addImage(imageIndex,response){
    ...
    if(imageIndex == 5){
        ...
        xmlhttp.open("POST","http://enigmatic-savannah-6672.herokuapp.com/recommmend",true);
