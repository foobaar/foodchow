		...
		<div id = "resultsSection" style="display:none">
			<article id="results1" class="container box style2">
				<header>
					...
					<p id="p1info">Some info</p><p ><br/><a id="a1link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results2" class="container box style2">
				<header>
					...
					<p id="p2info">Some info</p><p ><br/><a id="a2link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results3" class="container box style2">
				<header>
					...
					<p id="p3info">Some info</p><p ><br/><a id="a3link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results4" class="container box style2">
				<header>
					...
					<p id="p4info">Some info</p><p ><br/><a id="a4link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results5" class="container box style2">
				<header>
					...
					<p id="p5info">Some info</p><p ><br/><a id="a5link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results6" class="container box style2">
				<header>
					...
					<p id="p6info">Some info</p><p ><br/><a id="a6link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results7" class="container box style2">
				<header>
					...
					<p id="p7info">Some info</p><p ><br/><a id="a7link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results8" class="container box style2">
				<header>
					...
					<p id="p8info">Some info</p><p ><br/><a id="a8link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results9" class="container box style2">
				<header>
					...
					<p id="p9info">Some info</p><p ><br/><a id="a9link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
			...
			<article id="results10" class="container box style2">
				<header>
					...
					<p id="p10info">Some info</p><p ><br/><a id="a10link" target="new" href="http://www.yelp.com">yelp URL</a></p>
				</header>
			</article>
		</div>
		<!-- Contact 
