...
public class YelpClientImpl implements YelpClient {
    ...
    public String getRestaurents() {
        YelpResponse yelpResponse = restTemplate.getForObject(YELP_BASE_URL+"term=cream puffs&location=cincinnati&ywsid=GkEt7fj69eNfI-n7Bv3BPQ",YelpResponse.class);
        return String.valueOf(yelpResponse.getRestaurents().size());
    }
